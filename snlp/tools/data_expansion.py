...
@time: 2019/11/22 10:14
@description: 用于中文文本增强的函数
'''
import synonyms
import jieba
import random
...
stopwords_path = os.path.join(curdir, './resources/stopwords.txt')
...
def data_expansion(sentence, alpha_sr=0.1, alpha_ri=0.1, alpha_rs=0.1, p_rd=0.2, num_aug=9):
    ...
    :param alpha_sr: Replace synonym control param. 表示交换的同义词占总词数的比例
    :param alpha_ri: Random insert. 表示随机插入的词占总词数的比例
    :param alpha_rs: Random swap. 表示随机交换的次数占总词数的比例
    :param p_rd: Random delete. 表示每个词随机删除的概率
