...
class StyleProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        """See base class."""
        logger.info("Logging at {}".format(os.path.join(data_dir, 'train_0316.csv')))
        return self._create_examples(
            self._read_csv(os.path.join(data_dir, "train_0316.csv")), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_csv(os.path.join(data_dir, "val_0316.csv")), "dev")
    ...
    def get_labels(self):
        """See base class."""
        # return ["无", "高冷女神", "热情活泼", "浪漫文艺", "温柔知性", "其他"]
        return ["无", "高冷女神", "热情活泼", "浪漫文艺", "温柔知性"]
